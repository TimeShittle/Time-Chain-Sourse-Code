...
func newTestLDB() (*timechaindb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "timechaindb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := timechaindb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db timechaindb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db timechaindb.Database, t *testing.T) {
	const n = 8
