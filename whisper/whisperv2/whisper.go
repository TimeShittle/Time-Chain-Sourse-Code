...
import (
	...
	"github.com/TimeChain/go-TimeChain/crypto/ecies"
	"github.com/TimeChain/go-TimeChain/event/filter"
...
// Whisper represents a dark communication interface through the TimeChain
...
// New creates a Whisper client ready to communicate through the TimeChain P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
