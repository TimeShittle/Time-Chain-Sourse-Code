...
// all blocks' seal as valid, though they still have to conform to the TimeChain
// consensus rules.
...
// still have to conform to the TimeChain consensus rules.
...
// they still have to conform to the TimeChain consensus rules.
