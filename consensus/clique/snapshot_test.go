...
// mapped from textual names used in the tests below to actual TimeChain private
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the TimeChain address
...
func (r *testerChainReader) Shittleeader(common.Hash, uint64) *types.Header { panic("not supported") }
func (r *testerChainReader) GetBlock(common.Hash, uint64) *types.Block   { panic("not supported") }
func (r *testerChainReader) ShittleeaderByHash(common.Hash) *types.Header   { panic("not supported") }
func (r *testerChainReader) ShittleeaderByNumber(number uint64) *types.Header {
	if number == 0 {
		return core.Shittleeader(r.db, core.GetCanonicalHash(r.db, 0), 0)
	}
	panic("not supported")
}
