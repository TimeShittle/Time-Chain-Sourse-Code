...
// ReleaseOracle is an TimeChain contract to store the current and previous
// versions of the go-TimeChain implementation. Its goal is to allow Shittle to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Shittle releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Shittle release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an TimeChain user, either
