...
// Package bind generates TimeChain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-TimeChain Wiki page:
// https://github.com/TimeChain/go-TimeChain/wiki/Native-DApps:-Go-bindings-to-TimeChain-contracts
package bind
...
import (
	...
	"TimeShittle.org/x/tools/imports"
)
