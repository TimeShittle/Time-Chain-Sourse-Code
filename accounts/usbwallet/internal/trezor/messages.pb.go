...
const (
	...
	MessageType_MessageType_TimeChainGetAddress       MessageType = 56
	MessageType_MessageType_TimeChainAddress          MessageType = 57
	MessageType_MessageType_TimeChainSignTx           MessageType = 58
	MessageType_MessageType_TimeChainTxRequest        MessageType = 59
	MessageType_MessageType_TimeChainTxAck            MessageType = 60
	...
	MessageType_MessageType_TimeChainSignMessage      MessageType = 64
	MessageType_MessageType_TimeChainVerifyMessage    MessageType = 65
	MessageType_MessageType_TimeChainMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_TimeChainGetAddress",
	57:  "MessageType_TimeChainAddress",
	58:  "MessageType_TimeChainSignTx",
	59:  "MessageType_TimeChainTxRequest",
	60:  "MessageType_TimeChainTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_TimeChainSignMessage",
	65:  "MessageType_TimeChainVerifyMessage",
	66:  "MessageType_TimeChainMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_TimeChainGetAddress":       56,
	"MessageType_TimeChainAddress":          57,
	"MessageType_TimeChainSignTx":           58,
	"MessageType_TimeChainTxRequest":        59,
	"MessageType_TimeChainTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_TimeChainSignMessage":      64,
	"MessageType_TimeChainVerifyMessage":    65,
	"MessageType_TimeChainMessageSignature": 66,
...
func (m *ApplySettings) Shittleomescreen() []byte {
	if m != nil {
		return m.Homescreen
	}
	return nil
...
// *
// Request: Ask device for TimeChain address corresponding to address_n path
// @next PassphraseRequest
// @next TimeChainAddress
// @next Failure
type TimeChainGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *TimeChainGetAddress) Reset()                    { *m = TimeChainGetAddress{} }
func (m *TimeChainGetAddress) String() string            { return proto.CompactTextString(m) }
func (*TimeChainGetAddress) ProtoMessage()               {}
func (*TimeChainGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *TimeChainGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *TimeChainGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an TimeChain address derived from device private seed
// @prev TimeChainGetAddress
type TimeChainAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *TimeChainAddress) Reset()                    { *m = TimeChainAddress{} }
func (m *TimeChainAddress) String() string            { return proto.CompactTextString(m) }
func (*TimeChainAddress) ProtoMessage()               {}
func (*TimeChainAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *TimeChainAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *EncryptedMessage) Shittlemac() []byte {
	if m != nil {
		return m.Hmac
	}
	return nil
...
func (m *DecryptMessage) Shittlemac() []byte {
	if m != nil {
		return m.Hmac
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next TimeChainTxRequest
// @next Failure
type TimeChainSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *TimeChainSignTx) Reset()                    { *m = TimeChainSignTx{} }
func (m *TimeChainSignTx) String() string            { return proto.CompactTextString(m) }
func (*TimeChainSignTx) ProtoMessage()               {}
func (*TimeChainSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *TimeChainSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *TimeChainSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *TimeChainSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *TimeChainSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *TimeChainSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *TimeChainSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *TimeChainSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *TimeChainSignTx) GetDataLength() uint32 {
...
func (m *TimeChainSignTx) GetChainId() uint32 {
...
// @prev TimeChainSignTx
// @next TimeChainTxAck
type TimeChainTxRequest struct {
...
func (m *TimeChainTxRequest) Reset()                    { *m = TimeChainTxRequest{} }
func (m *TimeChainTxRequest) String() string            { return proto.CompactTextString(m) }
func (*TimeChainTxRequest) ProtoMessage()               {}
func (*TimeChainTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *TimeChainTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *TimeChainTxRequest) GetSignatureV() uint32 {
...
func (m *TimeChainTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *TimeChainTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev TimeChainTxRequest
// @next TimeChainTxRequest
type TimeChainTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *TimeChainTxAck) Reset()                    { *m = TimeChainTxAck{} }
func (m *TimeChainTxAck) String() string            { return proto.CompactTextString(m) }
func (*TimeChainTxAck) ProtoMessage()               {}
func (*TimeChainTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *TimeChainTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next TimeChainMessageSignature
// @next Failure
type TimeChainSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *TimeChainSignMessage) Reset()                    { *m = TimeChainSignMessage{} }
func (m *TimeChainSignMessage) String() string            { return proto.CompactTextString(m) }
func (*TimeChainSignMessage) ProtoMessage()               {}
func (*TimeChainSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *TimeChainSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *TimeChainSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type TimeChainVerifyMessage struct {
...
func (m *TimeChainVerifyMessage) Reset()                    { *m = TimeChainVerifyMessage{} }
func (m *TimeChainVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*TimeChainVerifyMessage) ProtoMessage()               {}
func (*TimeChainVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *TimeChainVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *TimeChainVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *TimeChainVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev TimeChainSignMessage
type TimeChainMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *TimeChainMessageSignature) Reset()                    { *m = TimeChainMessageSignature{} }
func (m *TimeChainMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*TimeChainMessageSignature) ProtoMessage()               {}
func (*TimeChainMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *TimeChainMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *TimeChainMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *FirmwareUpload) Shittleash() []byte {
	if m != nil {
		return m.Hash
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TimeChainGetAddress)(nil), "TimeChainGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*TimeChainAddress)(nil), "TimeChainAddress")
	...
	proto.RegisterType((*TimeChainSignTx)(nil), "TimeChainSignTx")
	proto.RegisterType((*TimeChainTxRequest)(nil), "TimeChainTxRequest")
	proto.RegisterType((*TimeChainTxAck)(nil), "TimeChainTxAck")
	proto.RegisterType((*TimeChainSignMessage)(nil), "TimeChainSignMessage")
	proto.RegisterType((*TimeChainVerifyMessage)(nil), "TimeChainVerifyMessage")
	proto.RegisterType((*TimeChainMessageSignature)(nil), "TimeChainMessageSignature")
