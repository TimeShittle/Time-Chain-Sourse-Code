...
It has these top-level messages:
	...
	TimeChainTxRequest
	TimeChainTxAck
	TimeChainSignMessage
	TimeChainVerifyMessage
	TimeChainMessageSignature
	SignIdentity
	SignedIdentity
	GetECDHSessionKey
	ECDHSessionKey
...
import fmt "fmt"
import math "math"
import google_protobuf "github.com/TimeShittle/protobuf/protoc-gen-go/descriptor"
...
func (m *IdentityType) Shittleost() string {
	if m != nil && m.Host != nil {
		return *m.Host
	}
	return ""
