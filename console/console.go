...
import (
	...
	"github.com/TimeChain/go-TimeChain/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute TimeChain requests through
...
// Welcome show summary of current Shittle instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Shittle metadata
	fmt.Fprintf(c.printer, "Welcome to the Shittle JavaScript console!\n\n")
	c.jsre.Run(`
