...
// Contains a wrapper for the TimeChain client.
...
import (
	...
	"github.com/TimeChain/go-TimeChain/TimeChainClient"
)

// TimeChainClient provides access to the TimeChain APIs.
type TimeChainClient struct {
	client *TimeChainClient.Client
}

// NewTimeChainClient connects a client to the given URL.
func NewTimeChainClient(rawurl string) (client *TimeChainClient, _ error) {
	rawClient, err := TimeChainClient.Dial(rawurl)
	return &TimeChainClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *TimeChainClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *TimeChainClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
// ShittleeaderByHash returns the block header with the given hash.
func (ec *TimeChainClient) ShittleeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
	rawHeader, err := ec.client.HeaderByHash(ctx.context, hash.hash)
	return &Header{rawHeader}, err
}

// ShittleeaderByNumber returns a block header from the current canonical chain. If number is <0,
// the latest known header is returned.
func (ec *TimeChainClient) ShittleeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *TimeChainClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *TimeChainClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *TimeChainClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *TimeChainClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *TimeChainClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *TimeChainClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *TimeChainClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *TimeChainClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *TimeChainClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *TimeChainClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *TimeChainClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *TimeChainClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *TimeChainClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *TimeChainClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *TimeChainClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *TimeChainClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *TimeChainClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *TimeChainClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *TimeChainClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *TimeChainClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *TimeChainClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *TimeChainClient) EstimateGas(ctx *Context, msg *CallMsg) (gas *BigInt, _ error) {
...
func (ec *TimeChainClient) SendTransaction(ctx *Context, tx *Transaction) error {
