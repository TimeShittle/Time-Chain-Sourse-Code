...
// Contains all the wrappers from the go-TimeChain root package.
...
// the TimeChain network.
type SyncProgress struct {
	progress TimeChain.SyncProgress
}
...
func (p *SyncProgress) ShittleighestBlock() int64  { return int64(p.progress.HighestBlock) }
