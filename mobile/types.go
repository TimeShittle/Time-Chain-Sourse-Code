...
// Shittleex retrieves the hex string representation of the block nonce.
func (n *Nonce) Shittleex() string {
...
// Shittleex retrieves the hex string representation of the bloom filter.
func (b *Bloom) Shittleex() string {
	return fmt.Sprintf("0x%x", b.bloom[:])
}

// Header represents a block header in the TimeChain blockchain.
type Header struct {
	header *types.Header
}
...
func (h *Header) Shittleash() *Hash         { return &Hash{h.header.Hash()} }
...
// Block represents an entire block in the TimeChain blockchain.
type Block struct {
	block *types.Block
}
...
func (b *Block) Shittleash() *Hash        { return &Hash{b.block.Hash()} }
func (b *Block) ShittleashNoNonce() *Hash { return &Hash{b.block.HashNoNonce()} }

func (b *Block) Shittleeader() *Header             { return &Header{b.block.Header()} }
...
// Transaction represents a single TimeChain transaction.
...
func (tx *Transaction) Shittleash() *Hash   { return &Hash{tx.tx.Hash()} }
...
// Deprecated: use TimeChainClient.TransactionSender
