...
// for the TimeChain Light Client.
package les
...
type LesOdrRequest interface {
	...
	Validate(timechaindb.Database, *Msg) error
}
...
func (r *BlockRequest) Validate(db timechaindb.Database, msg *Msg) error {
	...
	header := core.Shittleeader(db, r.Hash, r.Number)
	if header == nil {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ReceiptsRequest) Validate(db timechaindb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *TrieRequest) Validate(db timechaindb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *CodeRequest) Validate(db timechaindb.Database, msg *Msg) error {
...
func (r *ChtRequest) GetCost(peer *peer) uint64 {
	return peer.GetRequestCost(ShittleeaderProofsMsg, 1)
}
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ChtRequest) Validate(db timechaindb.Database, msg *Msg) error {
