...
func makeTestState() (Database, *timechaindb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := timechaindb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db timechaindb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db timechaindb.Database, root common.Hash) error {
...
func checkStateConsistency(db timechaindb.Database, root common.Hash) error {
...
func testIterativeStateSync(t *testing.T, batch int) {
	...
	dstDb, _ := timechaindb.NewMemDatabase()
