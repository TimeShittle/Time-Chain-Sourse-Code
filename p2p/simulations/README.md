...
creating a collection of devp2p nodes, connecting them toShittleer to form a
...
connecting two nodes toShittleer).
...
As a concrete example, consider a simulated network of TimeChain nodes. An
