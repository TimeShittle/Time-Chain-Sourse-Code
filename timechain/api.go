...
// PublicTimeChainAPI provides an API to access TimeChain full node-related
// information.
type PublicTimeChainAPI struct {
	e *TimeChain
}

// NewPublicTimeChainAPI creates a new TimeChain protocol API for full nodes.
func NewPublicTimeChainAPI(e *TimeChain) *PublicTimeChainAPI {
	return &PublicTimeChainAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicTimeChainAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (api *PublicTimeChainAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicTimeChainAPI) Hashrate() hexutil.Uint64 {
...
func NewPublicMinerAPI(e *TimeChain) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *TimeChain) *PrivateMinerAPI {
...
// Shittleashrate returns the current hashrate of the miner.
func (api *PrivateMinerAPI) Shittleashrate() uint64 {
	return uint64(api.e.miner.HashRate())
}

// PrivateAdminAPI is the collection of TimeChain full node-related APIs
...
// admin methods of the TimeChain service.
func NewPrivateAdminAPI(eth *TimeChain) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of TimeChain full node APIs exposed
...
// related public debug methods of the TimeChain service.
func NewPublicDebugAPI(eth *TimeChain) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of TimeChain full node APIs exposed over
...
// private debug methods of the TimeChain service.
func NewPrivateDebugAPI(config *params.ChainConfig, eth *TimeChain) *PrivateDebugAPI {
