...
// Syncing provides information when this nodes starts synchronising with the TimeChain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  TimeChain.SyncProgress `json:"status"`
}
