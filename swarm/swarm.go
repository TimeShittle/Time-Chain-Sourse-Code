...
import (
	...
	"github.com/TimeChain/go-TimeChain/contracts/chequebook"
	...
	"github.com/TimeChain/go-TimeChain/swarm/api"
	httpapi "github.com/TimeChain/go-TimeChain/swarm/api/http"
	"github.com/TimeChain/go-TimeChain/swarm/fuse"
	"github.com/TimeChain/go-TimeChain/swarm/network"
	"github.com/TimeChain/go-TimeChain/swarm/storage"
)
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *TimeChainClient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
