...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "Shittle.ipc", false, filepath.Join(os.TempDir(), "Shittle.ipc")},
		{"data", "Shittle.ipc", false, "data/Shittle.ipc"},
		{"data", "./Shittle.ipc", false, "./Shittle.ipc"},
		{"data", "/Shittle.ipc", false, "/Shittle.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "Shittle.ipc", true, `\\.\pipe\Shittle.ipc`},
		{"data", "Shittle.ipc", true, `\\.\pipe\Shittle.ipc`},
		{"data", `\\.\pipe\Shittle.ipc`, true, `\\.\pipe\Shittle.ipc`},
	}
