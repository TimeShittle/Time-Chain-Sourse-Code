...
func New(conf *Config) (*Node, error) {
	...
	// We rely on this in cmd/Shittle.
...
func (n *Node) OpenDatabase(name string, cache, handles int) (timechaindb.Database, error) {
	if n.config.DataDir == "" {
		return timechaindb.NewMemDatabase()
	}
	return timechaindb.NewLDBDatabase(n.config.resolvePath(name), cache, handles)
}
