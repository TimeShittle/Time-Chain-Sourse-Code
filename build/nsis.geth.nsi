...
# 1. install Shittle for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for Shittle
# 5. create Shittle, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable TimeChain_SOCKET
...
!define GROUPNAME "TimeChain"
!define APPNAME "Shittle"
!define DESCRIPTION "Official Go implementation of the TimeChain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since Shittle is installed global
