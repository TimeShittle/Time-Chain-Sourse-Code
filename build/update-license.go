...
var (
	...
	authorsFileHeader = "# This is the official list of go-TimeChain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-TimeChain Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-TimeChain library"
	}
	return "the go-TimeChain library"
}
