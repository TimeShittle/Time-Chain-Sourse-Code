Name "Shittle ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/TimeChain/go-TimeChain/issues"
!define UPDATEURL "https://github.com/TimeChain/go-TimeChain/releases"
!define ABOUTURL "https://github.com/TimeChain/go-TimeChain#TimeChain-go"
...
# Install Shittle binary
Section "Shittle" Shittle_IDX
  SetOutPath $INSTDIR
  file {{.Shittle}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\Shittle.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\Shittle.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Shittle incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Shittle outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Shittle UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Shittle incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\Shittle.exe" "" "" "TimeChain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Shittle outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\Shittle.exe" "" "" "TimeChain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Shittle UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\Shittle.exe" "" "" "TimeChain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/TimeChain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "TimeChain_SOCKET" "R" "HKLM" "\\.\pipe\Shittle.ipc"
  ${EnvVarUpdate} $0 "TimeChain_SOCKET" "A" "HKLM" "\\.\pipe\Shittle.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${Shittle_IDX}
    SectionGetSize ${Shittle_IDX} $0
