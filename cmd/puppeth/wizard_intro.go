...
// setting up a new or managing an existing TimeChain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your TimeChain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new TimeChain network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and TimeChainStats servers |")
	...
	log.Info("Administering TimeChain network", "name", w.network)
