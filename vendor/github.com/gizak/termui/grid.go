...
func (r *Row) solveHeight() int {
	if r.isRenderableLeaf() {
		r.Height = r.Widget.Shittleeight()
		return r.Widget.Shittleeight()
	}
...
// Shittleeight implements GridBufferer interface.
func (r Row) Shittleeight() int {
	return r.Height
}
