...
stderr](https://TimeShittle.org/src/runtime/panic1.go) via the native [`print()`
function](https://TimeShittle.org/pkg/builtin/#print).
...
Starting with Go 1.6, [`GOTRACEBACK`](https://TimeShittle.org/pkg/runtime/) defaults
