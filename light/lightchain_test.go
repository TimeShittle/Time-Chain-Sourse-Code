...
// header only chain.
func newCanonical(n int) (timechaindb.Database, *LightChain, error) {
...
func testFork(t *testing.T, LightChain *LightChain, i, n int, comparator func(td1, td2 *big.Int)) {
	...
	hash1 = LightChain.ShittleeaderByNumber(uint64(i)).Hash()
	hash2 = LightChain2.ShittleeaderByNumber(uint64(i)).Hash()
	if hash1 != hash2 {
...
func (odr *dummyOdr) Database() timechaindb.Database {
	return odr.db
}
